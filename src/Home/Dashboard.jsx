...
const dashboardStyles = [
  ...
  ".navbars2 { position: absolute; top: 40px; left: 0; background: #111; border-radius: 10px; padding: 10px; display: flex; flex-direction: column; gap: 8px; z-index: 950; min-width: 180px; box-shadow: 0 10px 30px rgba(0,0,0,0.3); }",
  ".navabarr a { display: flex; align-items: center; gap: 8px; text-decoration: none; color: inherit; white-space: nowrap; }",
  ".navbars { display: flex; flex-direction: column; gap: 10px; }",
  ".dashboard-content { display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 20px; }",
  "#myProjects, .home-response, .project-grid { overflow: visible !important; height: auto !important; max-height: none !important; }",
  "@media (max-width: 768px) { .homepage { flex-direction: column; text-align: center; } .navbars { display: none; } .dashboard-content { grid-template-columns: 1fr; } }",
  "@media (max-width: 480px) { .navbars2 { min-width: 150px; left: 0; right: 0; margin: 0 auto; } }",
].join(" ");
        ...
        <div className="dashboard">
          ...
          <div className="dashboard-content">
            ...
            <section className="contact-info">
              ...
              <a href="https://www.linkedin.com/in/kelvin-mwendwa-0b92063a">
                https://www.linkedin.com/in/kelvin-mwendwa-0b92063a
              </a>
              <p>
                GitHub:{" "}
                <a href="https://github.com/mwendwamutinda24">
                  https://github.com/mwendwamutinda24
                </a>
              </p>
            </section>
          </div>
