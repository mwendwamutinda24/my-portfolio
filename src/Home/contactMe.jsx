...
const ContactMe = () => {
  const handleSubmit = (e) => {
    ...
    const mailtoLink = `mailto:mwendwamutinda24@gmail.com?subject=Message from ${email}&body=${encodeURIComponent(message)}`;
      ...
      <div className="conect">
        <div className="con1">
          ...
          <div className="con-buttons">
            <button className="git1"><a href="https://github.com/mwendwamutinda24"><FaGithub/>Github</a></button>
            <button className="git2"><a href="https://www.instagram.com/kelvinsoftwareengineer/">< FaInstagram/>Instagram</a></button>
            <button className="git3"><a href="https://www.facebook.com/kingcorbin.junior.9"><FaFacebook/>Facebook</a></button>
