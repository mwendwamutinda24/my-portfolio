...
const MyProjects = () => {
        ...
        <section id="myProjects">
          ...
          <div className="myProject">
            ...
            <a href="https://pinecreative2-mw4b.vercel.app" target="_blank" rel="noopener noreferrer" className="project4">
              <img src={aboutImg} className="pines" alt="Pine Creative Project" />
              <p>
             ...
             <a href="https://propel-company-ai-website-zkh2.vercel.app/" target="_blank" rel="noopener noreferrer" className="project4">
              <img src="/Propel.png" className="pines" alt="Propel Company AI Project" />
              <p>
  ...
  className="project4"
>
  <img src="/Experbrain.png" className="pines" alt="ExperBrain Application" />
  <p>
  ...
  <div className="overlay"><span>View Project ➜</span></div>
             ...
             <a href="https://predictionsite-gr8r.vercel.app/" target="_blank" rel="noopener noreferrer" className="project4">
              <img src="./Ziggy Martoh.png" className="pines" alt="E-commerce Platform" />
            <p>
              A full‑stack MERN prediction platform designed for seamless match insights and user engagement.
            Built with modern tools like Nodejs,Reactjs, TailwindCSS, and JavaScript, it combines robust backend logic with a sleek, responsive interface. This project showcases secure data handling, intuitive design,
            and real‑time updates — delivering a smooth experience for both admins and users. 
            ...
            <a href="https://stephenkanjaportal.infinityfreeapp.com/" target="_blank" rel="noopener noreferrer" className="project4">
              <img src="./StephenKanja.jpg" className="pines" alt="School Portal" />
              <p>
            ...
            <a href="https://www.usfederalaid.com/" target="_blank" rel="noopener noreferrer" className="project4">
  <img src="./FederalAid .png" className="pines" alt="Federal Aid Portal" />
  <p>
    This is a Federal Aid project built with HTML, Tailwind CSS, JavaScript, and the MERN stack.
    It provides a secure and interactive platform for managing student financial aid applications,
    tracking eligibility, processing awards, and offering real-time updates to applicants. The
    system integrates authentication, responsive UI, and a robust backend to ensure smooth
    handling of aid records and communication between institutions and learners.
    <div className="toolsin">
      <p className="toolin"><FaReact/></p>
      <p className="toolin"><FaNodeJs/></p>
      <p className="toolin"><SiTailwindcss/></p>
      <p className="toolin"><SiJavascript/></p>
      <p className="toolin">MERN</p>
    </div>
  </p>
  <div className="overlay"><span>View Project ➜</span></div>
</a>
