      ...
      <div className="myProject">
        ...
        >
          ...
          <p>
            ...
            retrieving results for learners, and tracking their progress. The frontend is crafted
            using HTML and CSS, while the backend uses Laravel and REST APIs.
        ...
        >
          ...
          <p>
            ...
            modern UI, full mobile responsiveness, and fast performance. The frontend is crafted with
            React, styled using Tailwind CSS, and designed in Figma for a clean, professional look.
          </p>
           <div className="toolsin">
        ...
        <a
          href="https://stephenkanja.infinityfreeapp.com/"
          target="_blank"
          rel="noopener noreferrer"
          className="project4"
        >
          ...
          <p>
            ...
            authentication, and order management. The system is designed to provide a smooth and
            intuitive shopping experience with a responsive interface for both desktop and mobile users.
             <div className="toolsin">
               <p className="toolin"><SiLaravel/></p>
              <p className="toolin"><SiMysql/> </p>
               <p className="toolin"><SiTailwindcss/> </p>
